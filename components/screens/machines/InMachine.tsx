...
export default function InMachine() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const machineRef = doc(firestore, 'machines', data);
    ...
    const addProductToMachine = async (productName) => {
        // console.log("inAddProductToMachine")
        const firestore = getFirestore();
        const machineRef = doc(firestore, 'machines', data); // Reference to the warehouse
        const storageRef = collection(machineRef, 'storage'); // Reference to the storage collection of the warehouse
        try {
    ...
    const addProduct = () => {
        if (newProduct.trim() !== '') {
            ...
            addProductToMachine(newProduct); // Add the new product to the warehouse's storage
